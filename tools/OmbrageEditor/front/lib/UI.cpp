...
Ombrage::UI::UI(EXP_Game *game) {
    ...
    m_light_control = std::make_shared<EXP_GuiWindow>(game, RD_Rect{0, 390, 400, 100}, "Light Control", EXP_WindowFlags::WIN_NONE);
    m_file_control = std::make_shared<EXP_GuiWindow>(game, RD_Rect{0, 520, 400, 200}, "File", EXP_WindowFlags::WIN_NONE);
    m_work_area = std::make_shared<EXP_GuiWindow>(game, RD_Rect{400, 30, 880, 690}, "Node Tree", EXP_WindowFlags::WIN_NONE);

    m_save_btn = std::make_shared<EXP_GuiButton>(game, RD_Rect{10, 10, 380, 30}, "/texs/normal.jpg", "/texs/normal.png", "/texs/normal.png", m_file_control);
